...
if (isset($idusuario)) {
  $usuario_rs_usuario = $idusuario;
}
mysql_select_db($database_conecta, $conecta);
$query_rs_usuario = sprintf("SELECT unts_permissao . * , unts_usuario.*, unts_tesouraria . * FROM unts_permissao INNER JOIN unts_tesouraria ON unts_tesouraria.tesra_id = unts_permissao.tesra_id INNER JOIN unts_usuario ON unts_usuario.user_id = unts_permissao.user_id WHERE tesra_ativo = 'S' AND unts_permissao.user_id =%s", GetSQLValueString($usuario_rs_usuario, "int"));
...
<body>
  ...
  <?php do { ?>
    <tr>
      ...
      <td nowrap="nowrap"><a href="movimento.php?tesouraria=<?php echo $row_rs_usuario['tesra_id']; ?>"><?php echo $row_rs_usuario['tesra_descricao']; ?></a></td>
    </tr>
