...
$upd_unts_saldo_ini = new tNG_update($conn_unitas);
$tNGs->addTransaction($upd_unts_saldo_ini);
// Register triggers
$upd_unts_saldo_ini->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_unts_saldo_ini->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_unts_saldo_ini->registerTrigger("END", "Trigger_Default_Redirect", 99, "frm_saldo_inicial.php?tesouraria={GET.tesouraria}&movimento={movim_id}");
// Add columns
$upd_unts_saldo_ini->setTable("unts_saldo_ini");
$upd_unts_saldo_ini->addColumn("movim_id", "NUMERIC_TYPE", "POST", "movim_id");
$upd_unts_saldo_ini->addColumn("conta_id", "NUMERIC_TYPE", "POST", "conta_id");
$upd_unts_saldo_ini->addColumn("saldo_valor", "DOUBLE_TYPE", "POST", "saldo_valor");
$upd_unts_saldo_ini->addColumn("saldo_ativo", "STRING_TYPE", "POST", "saldo_ativo");
$upd_unts_saldo_ini->setPrimaryKey("saldo_id", "NUMERIC_TYPE", "GET", "saldo_id");
...
<form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>">
  <table cellpadding="2" cellspacing="0" class="KT_tngtable">
    ...
    <tr class="KT_buttons">
      <td colspan="2"><input type="submit" name="KT_Update1" id="KT_Update1" value="Salvar Altera&ccedil;&atilde;o" /></td>
    </tr>
  </table>
