...
<table width="100%">
  <tr>
    <td width="10%" align="left" valign="middle"><p><img src="/unitas/images/scj_logo.png" width="90" height="91" alt="Logomarca Sagrado Cora&ccedil;&atilde;o de Jesus" /></p></td>
...
<div id="botoes">
    ...
    <form action="/unitas/administracao/plus/tesouraria/frm_prest_contas_completa_imprimir.php?movimento=<?php echo $_GET['movimento'];?>&amp;tesouraria=<?php echo $_GET['tesouraria']; ?>" method="post" name="form1" target="_blank" id="form1">
      <label>
...
<table width="100%">
  ...
  <tr>
    <td align="center">Elza Regina dos Santos Pepino <br />
    1&ordm; Tesoureiro (a)</td>
    <td align="center">&nbsp;</td>
    <td align="center">Lucas Calvi de Souza<br />
    2&ordm; Tesoureiro (a)</td>
  </tr>
</table>
</body>
</html>
