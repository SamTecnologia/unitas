...
mysql_select_db($database_unitas, $unitas);
$query_rs_funcoes = sprintf("SELECT unts_usuario.*,    unts_permissao.*,    unts_funcao.* FROM unts_permissao INNER JOIN unts_usuario ON unts_usuario.user_id = unts_permissao.user_id INNER JOIN unts_funcao_usuario ON unts_funcao_usuario.user_id = unts_permissao.user_id INNER JOIN unts_funcao ON unts_funcao.func_id = unts_funcao_usuario.func_id WHERE tesra_id = %s", GetSQLValueString($tsraria_rs_funcoes, "int"));
...
<table width="100%">
  <tr>
    <td width="10%" height="93" align="left" valign="middle"><p><img src="/unitas/images/scj_logo.png" width="90" height="91" alt="Logomarca Sagrado Cora&ccedil;&atilde;o de Jesus" /></p></td>
...
<div id="botoes">
    ...
    <form action="/unitas/administracao/plus/tesouraria/frm_prest_contas_simplificada_imprimir.php?movimento=<?php echo $_GET['movimento'];?>&amp;tesouraria=<?php echo $_GET['tesouraria']; ?>" method="post" name="form1" target="_blank" id="form1">
      <label>
