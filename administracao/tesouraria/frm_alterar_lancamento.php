...
$upd_unts_item_mov = new tNG_update($conn_unitas);
$tNGs->addTransaction($upd_unts_item_mov);
// Register triggers
$upd_unts_item_mov->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_unts_item_mov->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_unts_item_mov->registerTrigger("END", "Trigger_Default_Redirect", 99, "/unitas/administracao/tesouraria/frm_visualizar_movimento.php?movimento={GET.movimento}");
// Add columns
$upd_unts_item_mov->setTable("unts_item_mov");
$upd_unts_item_mov->addColumn("movim_id", "NUMERIC_TYPE", "POST", "movim_id");
$upd_unts_item_mov->addColumn("item_data", "DATE_TYPE", "POST", "item_data");
$upd_unts_item_mov->addColumn("conta_id_e", "NUMERIC_TYPE", "POST", "conta_id_e");
$upd_unts_item_mov->addColumn("conta_id_s", "NUMERIC_TYPE", "POST", "conta_id_s");
$upd_unts_item_mov->addColumn("item_historico", "STRING_TYPE", "POST", "item_historico");
$upd_unts_item_mov->addColumn("item_documento", "STRING_TYPE", "POST", "item_documento");
$upd_unts_item_mov->addColumn("item_valor", "DOUBLE_TYPE", "POST", "item_valor");
$upd_unts_item_mov->addColumn("item_efetivado", "STRING_TYPE", "POST", "item_efetivado");
$upd_unts_item_mov->addColumn("item_ativo", "STRING_TYPE", "POST", "item_ativo");
$upd_unts_item_mov->setPrimaryKey("item_id", "NUMERIC_TYPE", "GET", "item");
...
?>
    ...
    <tr>
      <td class="KT_th"><label for="item_ativo">Ativo:</label></td>
      <td><select name="item_ativo" id="item_ativo">
        <option value="S" <?php if (!(strcmp("S", KT_escapeAttribute($row_rsunts_item_mov['item_ativo'])))) {echo "SELECTED";} ?>>Sim</option>
        <option value="N" <?php if (!(strcmp("N", KT_escapeAttribute($row_rsunts_item_mov['item_ativo'])))) {echo "SELECTED";} ?>>Nao</option>
      </select>
        <?php echo $tNGs->displayFieldError("unts_item_mov", "item_ativo"); ?></td>
    </tr>
    <tr class="KT_buttons">
