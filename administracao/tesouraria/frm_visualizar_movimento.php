...
<form id="form1" name="form1" method="post" action="/unitas/administracao/tesouraria/frm_tesouraria.php?movimento=<?php echo $_GET['movimento']; ?>">
    ...
    <form action="/unitas/administracao/tesouraria/frm_visualizar_movimento_imprimir.php?movimento=<?php echo $_GET['movimento'];?>&amp;tesouraria=<?php echo $row_rs_itens['tesra_id']; ?>" method="post" name="form1" target="_blank" id="form1">
      <label>
...
<table width="100%" border="1" cellspacing="0">
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center"><a href="/unitas/administracao/tesouraria/frm_alterar_lancamento.php?tesouraria=<?php echo $row_rs_itens['tesra_id']; ?>&item=<?php echo $row_rs_itens['item_id']?>&movimento= <?php echo $row_rs_itens['movim_id']; ?>"><img src="/unitas/images/editar.png" width="16" height="16" /></a></td>
      <td align="center"><a href="/unitas/administracao/tesouraria/frm_excluir_lancamento.php?item=<?php echo $row_rs_itens['item_id']; ?>&movimento=<?php echo $row_rs_itens['movim_id']; ?>"><img src="/unitas/images/excluir.png" width="16" height="16" /></a></td>
