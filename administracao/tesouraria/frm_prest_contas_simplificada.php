...
<div id="botoes">
    ...
    <form action="/unitas/administracao/tesouraria/frm_prest_contas_simplificada_imprimir.php?movimento=<?php echo $_GET['movimento'];?>&amp;tesouraria=<?php echo $_GET['tesouraria']; ?>" method="post" name="form1" target="_blank" id="form1">
      <label>
