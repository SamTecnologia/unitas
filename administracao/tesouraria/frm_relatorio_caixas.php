...
<div id="botoes">
    ...
    <form action="/unitas/administracao/tesouraria/frm_relatorio_caixas_imprimir.php?movimento=<?php echo $_GET['movimento'];?>&amp;tesouraria=<?php echo $_GET['tesouraria']; ?>" method="post" name="form1" target="_blank" id="form1">
      <label>
...
<?php if ($totalRows_rs_caixas > 0) { // Show if recordset not empty ?>
  ...
  <div class="page" style="page-break-after: always;width:900px;">
    <table width="100%">
      <tr>
      ...
      <tr>
        ...
        <td align="center"><img src="/unitas/images/psmd_logo.png" width="64" height="78" alt="Logomarca Paroquia Santa M&atilde;e de Deus" /></td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr align="center" valign="middle">
        <td colspan="2" rowspan="3"><img src="/unitas/images/tesourarias_logo/<?php echo $row_rs_com_tesouraria['comun_id']; ?>/<?php echo $row_rs_com_tesouraria['comun_icone']; ?>" width="87" height="73" alt="logomarca <?php echo $row_rs_com_tesouraria['comun_razao_social']; ?>" /><br /></td>
        <td colspan="3" align="left" valign="middle"><strong> Par&oacute;quia Santa M&atilde;e de Deus</strong></td>
        <td colspan="2" rowspan="3" align="right">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="7" align="center"><table width="100%">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="center"><?php echo $prim_tes;?><br />
              Primeiro (a) Tesoureiro (a)</td>
            <td>&nbsp;</td>
